...
{
    public class PizzeriaAFactory : IPizzeria
    {
        private readonly List<string> _log = new List<string>();
        private const string Pizza = "A";
        ...
        {
            return CheeseTypes.Mozzarella;
        }

        public ClamTypes GetClam()
        {
            return ClamTypes.Frozen_Clam;
        }

        public DoughTypes GetDough()
        {
            return DoughTypes.Thin_Crust;
        }
        public SauceTypes GetSauce()
        {
            return SauceTypes.Cherry_Tomato;
        }
